...
export const BACKGROUND_COLOR_AVAILABLE = "#C3CFD9";
export const BORDER_COLOR_AVAILABLE = "#7B8B99";
export const BACKGROUND_COLOR_UNAVAILABLE = "#FBE192";
export const BORDER_COLOR_UNAVAILABLE = "#F7C52B";
